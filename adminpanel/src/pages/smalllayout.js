...
class title extends Component {
    ...
    getData = async (page) => {
        try {
            ...
            let resData = await axios.get(`${process.env.REACT_APP_URL_NODE}smallayout/files`, fillDataTable)
        ...
        try {
            ...
            if (result.isConfirmed) {
                const resultSave = await Swal.fire({
                    toast: true,
                    title: 'Small Layout Deleted Successfully',
                    icon: 'success',
                })
                ...
                if (resultSave.isConfirmed) {
                    ...
                    let resData = await axios.post(`${process.env.REACT_APP_URL_NODE}smallayout/delete`, objUserId);
    ...
    handleChangeUpdate = async (e) => {
        ...
        let resData = await axios.post(`${process.env.REACT_APP_URL_NODE}smallayout/edit`, objUserId);
    ...
    upload(idx, file) {
        ...
        UploadService.uploadSmallLayout({ file: file, username: 'sunil', titlename: this.state.titlename, mua: this.state.mua }, (event) => {
    ...
    upadteUploadImages = async (e) => {
        ...
        let resData = await axios.post(`${process.env.REACT_APP_URL_NODE}smallayout/upadte`, objUpdate);
            ...
            <>
                ...
                <Container fixed>
                    ...
                    <Button style={{
                        ...
                        //padding: "18px 36px",
                        //fontSize: "18px"
                    }} variant="outlined" onClick={this.handleClickOpen}>Add Small Layout</Button>

                    {/* add dialog popup */}
                    <Dialog open={this.state.setOpen} onClose={this.handleClose}>
                        <DialogTitle>Add Small Layout    Banner</DialogTitle>
                        <DialogContent>
                            <DialogContentText>
                                ...
                                <Grid container spacing={3}>
                                    ...
                                    <Grid item
                                        ...
                                        <TextField
                                            id="outlined-basic"
                                            style={{ width: '100%' }}
                                            label="Makeup Artist Name"
                                            variant="outlined"
                                            name="mua"
                                            value={this.state.mua}
                                            onChange={this.handleChange}
                                            required
                                        />
                                    </Grid>
    ...
    Add
                    ...
                    <Dialog open={this.state.setOpen2} onClose={this.handleClose}>
                        <DialogTitle>Edit Siliding Banner</DialogTitle>
                        <DialogContent>
                            <DialogContentText>
                                {/* To subscribe to this website, please enter your email address here. We
                                will send updates occasionally. */}
